...
namespace WazFactor\CPT;

// Internal Dependencies
use WazFactor\CPT\PostType\{CustomPostTypeSubscriber, CustomPostTypeServiceProvider};
use WazFactor\CPT\Internal\EventManagement\{EventManagerServiceProvider, EventManagerSubscriber};
use WazFactor\CPT\Internal\Translation\TranslationServiceProvider;
